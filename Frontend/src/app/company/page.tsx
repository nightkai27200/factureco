...
export default function CompanyPage() {
  ...
  function updateSiret(value: string) {
  ...
  function updateVatNumber(value: string) {
  ...
  async function saveCompany() {
    ...
    if (
      ...
      alert(
        "Le numéro de TVA doit être au format FR + 11 caractères."
      );
